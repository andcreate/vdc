...
const FeatureList: FeatureItem[] = [
  ...
  {
    title: "ドキュメント",
    Svg: require("./img/book-svgrepo-com.svg").default,
    description: (
      <>
        <p className="">各アセットの使い方はこちら。</p>
        <Link to="/docs/intro">
  ...
  {
    title: "Booth",
    Svg: require("./img/download-svgrepo-com.svg").default,
    description: (
      <>
        <p>デジタルコンテンツはこちら</p>
        <Link href="https://andcreate.booth.pm/" target="_blank" className={"mt-8 "}>
...
function Feature({ title, Svg, description }: FeatureItem) {
  return (
    <div className={clsx("col col--4 mt-[3.25rem]")}>
      <div className="text-center mx-auto">
        <Svg className="mx-auto w-1/5 h-1/5" role="img" />
      </div>
